...
(ert-deftest alda-play-text-test ()
  ...
  (with-mock
    (mock-alda-cmd "play" "--code" "piano: c d e")
    (alda-play-text "piano: c d e")

    (mock-alda-cmd "play" "--code" "piano: c d
e f g")
    (alda-play-text "piano: c d
e f g")

    (mock-alda-cmd "play" "--code" "guitar: \"d e f\"")
...
(ert-deftest alda-play-buffer-test ()
  ...
  (with-mock
    ...
    (mock-alda-cmd "play" "--code" "midi-square-wave: c d e")
    (alda-play-buffer)))
